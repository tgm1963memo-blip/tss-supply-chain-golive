...
export default function StockOverviewPage() {
  return (
    <MockupPageShell
      ...
      purpose="Executive inventory health — on-hand value, turnover, and zero-stock alerts."
      ...
      workflowNotes={[
        ...defaultWorkflowNotes,
        'Screen-specific: Stock Overview — menu regroup placeholder; source migration pending.',
      ]}
      businessRules={[
        ...defaultBusinessRules,
        'Stock Overview: awaiting business rule sign-off before live integration.',
      ]}
      nextSteps={[
        ...defaultNextSteps,
